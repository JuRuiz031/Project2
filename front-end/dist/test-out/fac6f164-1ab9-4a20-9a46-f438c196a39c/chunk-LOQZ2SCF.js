...
var init_router_chunk = __esm({
  "node_modules/@angular/router/fesm2022/_router-chunk.mjs"() {
    ...
    NoMatch$1 = class NoMatch extends Error {
      segmentGroup;
    ...
    AbsoluteRedirect$1 = class AbsoluteRedirect extends Error {
      urlTree;
      constructor(urlTree) {
        super();
    ...
    ApplyRedirects$1 = class ApplyRedirects {
      urlSerializer;
      urlTree;
    ...
    NoLeftoversInUrl$1 = class NoLeftoversInUrl {
    };
    MAX_ALLOWED_REDIRECTS$1 = 31;
    Recognizer$1 = class Recognizer {
      injector;
      configLoader;
      rootComponentType;
      config;
...
This is currently a dev mode only error but will become a call stack size exceeded error in production in a future major version.`);
    ...
    RECOGNIZE_IMPL = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "RECOGNIZE_IMPL" : "", {
      factory: () => {
        return recognize$2;
      }
    });
...
var RouterLink, RouterLinkActive, PreloadingStrategy, PreloadAllModules, NoPreloading, RouterPreloader, ROUTER_SCROLLER, RouterScroller, NavigationStateManager, ROUTER_IS_PROVIDED, BOOTSTRAP_DONE, INITIAL_NAVIGATION, ROUTER_PRELOADER, ROUTER_DIRECTIVES, ROUTER_FORROOT_GUARD, ROUTER_PROVIDERS, RouterModule, ROUTER_INITIALIZER;
var init_router_module_chunk = __esm({
  "node_modules/@angular/router/fesm2022/_router_module-chunk.mjs"() {
    ...
    NavigationStateManager = class _NavigationStateManager extends HistoryStateManager {
...
@angular/router/fesm2022/router.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-LOQZ2SCF.js.map
