...
var activeConsumer, inNotificationPhase, epoch, postProducerCreatedFn, SIGNAL, REACTIVE_NODE, UNSET, COMPUTING, ERRORED, COMPUTED_NODE, throwInvalidWriteToSignalErrorFn, postSignalSetFn, SIGNAL_NODE, BASE_EFFECT_NODE;
var init_effect_chunk = __esm({
  "node_modules/@angular/core/fesm2022/_effect-chunk.mjs"() {
    "use strict";
    activeConsumer = null;
...
var init_not_found_chunk = __esm({
  "node_modules/@angular/core/fesm2022/_not_found-chunk.mjs"() {
    "use strict";
...
var init_linked_signal_chunk = __esm({
  "node_modules/@angular/core/fesm2022/_linked_signal-chunk.mjs"() {
    "use strict";
    init_effect_chunk();
...
var formatter;
var init_primitives_signals = __esm({
  "node_modules/@angular/core/fesm2022/primitives-signals.mjs"() {
    "use strict";
    init_effect_chunk();
    init_effect_chunk();
...
var init_primitives_di = __esm({
  "node_modules/@angular/core/fesm2022/primitives-di.mjs"() {
    "use strict";
    init_not_found_chunk();
  }
});
...
var Version, VERSION, ERROR_DETAILS_PAGE_BASE_URL, XSS_SECURITY_URL, RuntimeError, _global, __forward_ref__, NG_PROV_DEF, NG_INJ_DEF, InjectionToken, _injectorProfilerContext, injectorProfilerCallbacks, NOOP_PROFILER_REMOVAL, NG_COMP_DEF, NG_DIR_DEF, NG_PIPE_DEF, NG_MOD_DEF, NG_FACTORY_DEF, NG_ELEMENT_ID, NG_ENV_ID, NG_RUNTIME_ERROR_CODE, NG_RUNTIME_ERROR_MESSAGE, NG_TOKEN_PATH, _injectImplementation, _THROW_IF_NOT_FOUND, THROW_IF_NOT_FOUND, DI_DECORATOR_FLAG, RetrievingInjector, EMPTY_OBJ, EMPTY_ARRAY, ENVIRONMENT_INITIALIZER, INJECTOR$1, INJECTOR_DEF_TYPES, NullInjector, USE_VALUE, INJECTOR_SCOPE, NOT_YET, CIRCULAR, NULL_INJECTOR, EnvironmentInjector, R3Injector, HOST, TVIEW, FLAGS, PARENT, NEXT, T_HOST, HYDRATION, CLEANUP, CONTEXT, INJECTOR, ENVIRONMENT, RENDERER, CHILD_HEAD, CHILD_TAIL, DECLARATION_VIEW, DECLARATION_COMPONENT_VIEW, DECLARATION_LCONTAINER, PREORDER_HOOK_FLAGS, QUERIES, ID, EMBEDDED_VIEW_INJECTOR, ON_DESTROY_HOOKS, EFFECTS_TO_SCHEDULE, EFFECTS, REACTIVE_TEMPLATE_CONSUMER, AFTER_RENDER_SEQUENCES_TO_ADD, ANIMATIONS, HEADER_OFFSET, TYPE, DEHYDRATED_VIEWS, NATIVE, VIEW_REFS, MOVED_VIEWS, CONTAINER_HEADER_OFFSET, SVG_NAMESPACE, MATH_ML_NAMESPACE, instructionState, CheckNoChangesMode, _checkNoChangesMode, _isRefreshingViews, leaveDI, _wasLastNodeCreated, Injector, DOCUMENT, DestroyRef, NodeInjectorDestroyRef, SCHEDULE_IN_ROOT_ZONE_DEFAULT, PendingTasksInternal, EventEmitter_, EventEmitter, AsyncStackTaggingZoneSpec, isAngularZoneProperty, angularZoneInstanceIdProperty, ngZoneInstanceId, NgZone, EMPTY_PAYLOAD, NoopNgZone, ErrorHandler, INTERNAL_APPLICATION_ERROR_HANDLER, errorHandlerEnvironmentInitializer, globalErrorListeners, ViewContext, ChangeDetectionScheduler, ZONELESS_ENABLED, PROVIDED_ZONELESS, SCHEDULE_IN_ROOT_ZONE, PendingTasks, EffectScheduler, ZoneAwareEffectScheduler, EffectRefImpl, EFFECT_NODE, ROOT_EFFECT_NODE, VIEW_EFFECT_NODE;
var init_untracked_chunk = __esm({
  "node_modules/@angular/core/fesm2022/_untracked-chunk.mjs"() {
    "use strict";
    init_effect_chunk();
    init_esm();
    init_not_found_chunk();
    init_primitives_signals();
    init_primitives_di();
    Version = class {
      full;
      major;
    ...
    VERSION = /* @__PURE__ */ new Version("21.0.8");
    ...
    NG_RUNTIME_ERROR_CODE = getClosureSafeProperty({
      "ngErrorCode": getClosureSafeProperty
    });
    NG_RUNTIME_ERROR_MESSAGE = getClosureSafeProperty({
      "ngErrorMessage": getClosureSafeProperty
    });
    NG_TOKEN_PATH = getClosureSafeProperty({
    ...
    ENVIRONMENT_INITIALIZER = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "ENVIRONMENT_INITIALIZER" : "");
    INJECTOR$1 = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "INJECTOR" : "", -1);
    INJECTOR_DEF_TYPES = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "INJECTOR_DEF_TYPES" : "");
    NullInjector = class {
    ...
    INJECTOR_SCOPE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "Set Injector scope." : "");
    NOT_YET = {};
    CIRCULAR = {};
    ...
    DOCUMENT = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "DocumentToken" : "");
    DestroyRef = class {
    ...
    globalErrorListeners = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "GlobalErrorListeners" : "", {
      factory: () => {
        if (false) {
          return;
        }
    ...
    EFFECT_NODE = /* @__PURE__ */ (() => __spreadProps(__spreadValues({}, BASE_EFFECT_NODE), {
      cleanupFns: void 0,
      zone: null,
      onDestroyFns: null,
      run() {
    ...
    ROOT_EFFECT_NODE = /* @__PURE__ */ (() => __spreadProps(__spreadValues({}, EFFECT_NODE), {
      consumerMarkedDirty() {
    ...
    VIEW_EFFECT_NODE = /* @__PURE__ */ (() => __spreadProps(__spreadValues({}, EFFECT_NODE), {
      consumerMarkedDirty() {
...
var init_debug_node_chunk = __esm({
  "node_modules/@angular/core/fesm2022/_debug_node-chunk.mjs"() {
    ...
    Inject = attachInjectFlag(makeParamDecorator("Inject", (token) => ({
      token
    })), -1);
    Optional = attachInjectFlag(makeParamDecorator("Optional"), 8);
    Self = attachInjectFlag(makeParamDecorator("Self"), 2);
    SkipSelf = attachInjectFlag(makeParamDecorator("SkipSelf"), 4);
    Host = attachInjectFlag(makeParamDecorator("Host"), 1);
    angularCoreDiEnv = {
    ...
    Attribute = makeParamDecorator("Attribute", (attributeName2) => ({
    ...
    DOCUMENT2 = void 0;
    APP_ID = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "AppId" : "", {
    ...
    PLATFORM_INITIALIZER = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "Platform Initializer" : "");
    PLATFORM_ID = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "Platform ID" : "", {
      providedIn: "platform",
      factory: () => "unknown"
    });
    ANIMATION_MODULE_TYPE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "AnimationModuleType" : "");
    CSP_NONCE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "CSP nonce" : "", {
      factory: () => {
    ...
    IMAGE_CONFIG = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "ImageConfig" : "", {
    ...
    EVENT_REPLAY_QUEUE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "EVENT_REPLAY_QUEUE" : "", {
      factory: () => []
    });
    ...
    JSACTION_BLOCK_ELEMENT_MAP = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "JSACTION_BLOCK_ELEMENT_MAP" : "", {
      factory: () => /* @__PURE__ */ new Map()
    });
    IS_ENABLED_BLOCKING_INITIAL_NAVIGATION = new InjectionToken(typeof ngDevMode === "undefined" || ngDevMode ? "IS_ENABLED_BLOCKING_INITIAL_NAVIGATION" : "");
    ...
    intersectionObservers = /* @__PURE__ */ new Map();
    ...
    JSACTION_EVENT_CONTRACT = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "EVENT_CONTRACT_DETAILS" : "", {
      factory: () => ({})
    });
    _stashEventListenerImpl = (lView, target, eventName, wrappedListener) => {
    };
    DEHYDRATED_BLOCK_REGISTRY = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "DEHYDRATED_BLOCK_REGISTRY" : "");
    ...
    SRC_RESOURCE_TAGS = /* @__PURE__ */ new Set(["embed", "frame", "iframe", "media", "script"]);
    HREF_RESOURCE_TAGS = /* @__PURE__ */ new Set(["base", "link", "script"]);
    attributeName = /* @__PURE__ */ new Set(["attributename"]);
    ...
    allLeavingAnimations = /* @__PURE__ */ new Set();
    ...
    TracingService = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TracingService" : "");
    ...
    AFTER_RENDER_PHASES = /* @__PURE__ */ (() => [0, 1, 2, 3])();
    ...
    ANIMATION_QUEUE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "AnimationQueue" : "", {
      factory: () => {
        return {
    ...
    UseExhaustiveCheckNoChanges = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "exhaustive checkNoChanges" : "");
    freeConsumers = [];
    ...
    DEFER_BLOCK_CONFIG = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "DEFER_BLOCK_CONFIG" : "");
    ...
    ANIMATIONS_DISABLED = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "AnimationsDisabled" : "", {
      factory: () => false
    });
    MAX_ANIMATION_TIMEOUT = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "MaxAnimationTimeout" : "", {
      factory: () => MAX_ANIMATION_TIMEOUT_DEFAULT
    });
    MAX_ANIMATION_TIMEOUT_DEFAULT = 4e3;
    DEFAULT_ANIMATIONS_DISABLED = false;
    areAnimationSupported = typeof document !== "undefined" && typeof document?.documentElement?.getAnimations === "function";
    noOpAnimationComplete = () => {
    };
    enterClassMap = /* @__PURE__ */ new WeakMap();
    longestAnimations = /* @__PURE__ */ new WeakMap();
    leavingNodes = /* @__PURE__ */ new WeakMap();
    DISABLED = /* @__PURE__ */ getClosureSafeProperty({
      disabled: getClosureSafeProperty
    });
    MAX = /* @__PURE__ */ getClosureSafeProperty({
      max: getClosureSafeProperty
    });
    MAX_LENGTH = /* @__PURE__ */ getClosureSafeProperty({
      maxLength: getClosureSafeProperty
    });
    MIN = /* @__PURE__ */ getClosureSafeProperty({
      min: getClosureSafeProperty
    });
    MIN_LENGTH = /* @__PURE__ */ getClosureSafeProperty({
      minLength: getClosureSafeProperty
    });
    NAME = /* @__PURE__ */ getClosureSafeProperty({
      name: getClosureSafeProperty
    });
    READONLY = /* @__PURE__ */ getClosureSafeProperty({
      readonly: getClosureSafeProperty
    });
    REQUIRED = /* @__PURE__ */ getClosureSafeProperty({
      required: getClosureSafeProperty
    });
    CONTROL_VALUE = /* @__PURE__ */ getClosureSafeProperty({
    ...
    CONTROL_BINDING_KEYS = /* @__PURE__ */ (() => Object.keys(CONTROL_BINDING_NAMES))();
    ...
    NgModule = makeDecorator("NgModule", (ngModule) => ngModule, void 0, void 0, (type, meta) => compileNgModule(type, meta));
    ...
    COMPILER_OPTIONS = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "compilerOptions" : "");
    ...
    LOCALE_ID = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "LocaleId" : "", {
      factory: () => inject2(LOCALE_ID, {
        optional: true,
        skipSelf: true
      }) || getGlobalLocale()
    });
    DEFAULT_CURRENCY_CODE = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "DefaultCurrencyCode" : "", {
      factory: () => USD_CURRENCY_CODE
    });
    TRANSLATIONS = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "Translations" : "");
    TRANSLATIONS_FORMAT = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "TranslationsFormat" : "");
...
var OutputEmitterRef, identityFn, BaseWritableResource, ResourceImpl, ResourceValueError, ResourceWrappedError;
var init_resource_chunk = __esm({
  "node_modules/@angular/core/fesm2022/_resource-chunk.mjs"() {
    "use strict";
    init_untracked_chunk();
    init_effect_chunk();
    init_linked_signal_chunk();
...
var REQUIRED_UNSET_VALUE, INPUT_SIGNAL_NODE, FactoryTarget, R3TemplateDependencyKind, ViewEncapsulation2, Framework, HostAttributeToken, input, viewChild, contentChild, model, emitDistinctChangesOnlyDefaultValue, Query, ContentChildren, ContentChild, ViewChildren, ViewChild, NgZoneChangeDetectionScheduler, PROVIDED_NG_ZONE, ZoneStablePendingTask, SCAN_DELAY, OVERSIZED_IMAGE_TOLERANCE, ImagePerformanceWarning, PLATFORM_DESTROY_LISTENERS, ENABLE_ROOT_COMPONENT_BOOTSTRAP, moduleBootstrapImpl, PlatformRef, _platformInjector, ChangeDetectorRef, DefaultIterableDifferFactory, trackByIdentity, DefaultIterableDiffer, IterableChangeRecord_, _DuplicateItemRecordList, _DuplicateMap, DefaultKeyValueDifferFactory, DefaultKeyValueDiffer, KeyValueChangeRecord_, IterableDiffers, KeyValueDiffers, keyValDiff, iterableDiff, defaultIterableDiffers, defaultKeyValueDiffers, platformCore, ApplicationModule, REQUEST, RESPONSE_INIT, REQUEST_CONTEXT;
var init_core = __esm({
  "node_modules/@angular/core/fesm2022/core.mjs"() {
    "use strict";
    init_untracked_chunk();
    ...
    PLATFORM_DESTROY_LISTENERS = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "PlatformDestroyListeners" : "");
    ENABLE_ROOT_COMPONENT_BOOTSTRAP = new InjectionToken(typeof ngDevMode !== "undefined" && ngDevMode ? "ENABLE_ROOT_COMPONENT_BOOTSTRAP" : "");
...
@angular/core/fesm2022/core.mjs:
   ...
   *)
*/
//# sourceMappingURL=chunk-5EHNMWHP.js.map
